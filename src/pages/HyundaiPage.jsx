...
import heroImg from '../assets/brands/hyundai.jpg';
...
export default function HyundaiPage() {
  ...
  const hyundaiCars = useMemo(
    () => products.filter((p) => p.brand === "Hyundai"),
    []
  );
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ...
            : "হুন্ডাই গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Hyundai models with detailed specs and pricing."
            : "আমাদের সর্বশেষ হুন্ডাই মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
