...
import heroImg from '../assets/brands/audi.jpg'; // অডি হিরো ইমেজ
...
export default function AudiPage() {
  ...
  // ফিল্টার করা অডি গাড়ি
  const audiCars = useMemo(
    () => products.filter((p) => p.brand === "Audi"),
    []
  );

  const [visibleCount, setVisibleCount] = useState(10); // Lazy load প্রথম 10 টি
    ...
    <div className="min-h-screen mt-30 bg-gray-50">
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ? "Audi Cars Collection"
            : "অডি গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Audi models with detailed specs and pricing."
            : "আমাদের সর্বশেষ অডি মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
