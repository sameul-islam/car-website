...
export default function ElectricCarsPage() {
  ...
  const electricCars = products.filter(
    (car) => car.category && car.category === "Electric"
  );
      ...
      <section className="bg-white shadow-md py-10 mb-6">
        <div className="w-[90%] mx-auto text-center">
          <h1 className="text-4xl font-bold text-[#273c75] mb-2">
            {language === "EN" ? "Electric " : "ইলেকট্রিক "}
          ...
          <p className="text-gray-500">
            {language === "EN"
              ? "Explore our collection of electric cars"
              : "আমাদের ইলেকট্রিক গাড়ির কালেকশন দেখুন"}
          </p>
        </div>
      </section>
