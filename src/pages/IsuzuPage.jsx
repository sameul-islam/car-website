...
import heroImg from "../assets/brands/isuzu.jpg"; 
...
export default function IsuzuPage() {
  ...
  const isuzuCars = useMemo(
    () => products.filter((p) => p.brand === "Isuzu"),
    []
  );
  ...
  return (
    <div className="min-h-screen mt-30 bg-gray-50">
      ...
      <section
        className="relative bg-cover bg-center h-64 md:h-[500px] md:w-[82%] m-auto flex flex-col justify-center items-center text-white text-center px-4"
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ? "Isuzu Cars Collection"
            : "ইসুজু গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Isuzu models with detailed specs and pricing."
            : "আমাদের সর্বশেষ ইসুজু মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
