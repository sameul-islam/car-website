...
import heroImg from '../assets/brands/lamborghini.jpg'
...
export default function LamborghiniPage() {
  ...
  const lamborghiniCars = useMemo(
    () => products.filter((p) => p.brand === "Lamborghini"),
    []
  );
  ...
  const filteredCars = useMemo(() => {
    return lamborghiniCars.filter((car) => {
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ...
            : "ল্যাম্বরগিনি গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Lamborghini models with detailed specs and pricing."
            : "আমাদের সর্বশেষ ল্যাম্বরগিনি মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
