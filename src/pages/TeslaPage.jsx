...
import heroImg from '../assets/brands/tesla.jpg'; 
...
export default function TeslaPage() {
  ...
  // ফিল্টার করা টেসলা গাড়ি
  const teslaCars = useMemo(
    () => products.filter((p) => p.brand === "Tesla"),
    []
  );
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ...
            : "টেসলা গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Tesla models with detailed specs and pricing."
            : "আমাদের সর্বশেষ টেসলা মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
