...
export default function OldCar() {
  ...
  const oldCars = products.filter(
    (car) => car.type && car.type.toLowerCase() === "old"
  );
      ...
      <section className="bg-white shadow-md py-10 mb-6">
        <div className="w-[90%] mx-auto text-center">
          ...
          <p className="text-gray-500">
            {language === "EN"
              ? "Explore our collection of old cars"
              : "আমাদের পুরনো গাড়ির কালেকশন দেখুন"}
          </p>
        </div>
      </section>
      ...
      <section className="w-[90%] mx-auto pb-10">
        {oldCars.length > 0 ? (
          ...
          <div className="text-center py-10 text-gray-500 text-xl">
            {language === "EN"
              ? "No old cars available"
              : "কোনো পুরনো গাড়ি নেই"}
          </div>
        )}
      </section>
    </div>
