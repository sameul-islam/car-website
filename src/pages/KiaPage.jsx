...
import heroImg from '../assets/brands/kia.jpg';
...
export default function KiaPage() {
  ...
  // Filter only Kia cars
  const kiaCars = useMemo(
    () => products.filter((p) => p.brand === "Kia"),
    []
  );
    ...
    <div className="min-h-screen mt-30 bg-gray-50">
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ? "Kia Cars Collection"
            : "কিয়া গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Kia models with detailed specs and pricing."
            : "আমাদের সর্বশেষ কিয়া মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
