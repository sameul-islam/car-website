...
import heroImg from '../assets/brands/porsche.jpg';
...
export default function PorschePage() {
  ...
  // Filter only Porsche cars
  const porscheCars = useMemo(
    () => products.filter((p) => p.brand === "Porsche"),
    []
  );
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ...
            : "পোর্শে গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Porsche models with detailed specs and pricing."
            : "আমাদের সর্বশেষ পোর্শে মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
