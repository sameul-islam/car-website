...
export default function LuxuryCarsPage() {
  ...
  const luxuryCars = products.filter((car) => car.category === "Luxury");
        ...
        <div className="w-[90%] mx-auto text-center">
          ...
          <p className="text-gray-500">
            {language === "EN"
              ...
              : "আমাদের লাগজারী গাড়ির কালেকশন দেখুন"}
          </p>
        </div>
      </section>
      ...
      <section className="w-[90%] mx-auto pb-10">
        {luxuryCars.length > 0 ? (
          ...
          <div className="text-center py-10 text-gray-500 text-xl">
            {language === "EN"
              ? "No luxury cars available"
              : "কোনো লাগজারী গাড়ি নেই"}
          </div>
        )}
      </section>
    </div>
