...
import heroImg from '../assets/brands/lucid.jpg';
...
export default function LucidPage() {
  ...
  // Filter only Lucid cars
  const lucidCars = useMemo(
    () => products.filter((p) => p.brand === "Lucid"),
    []
  );
    ...
    <div className="min-h-screen mt-30 bg-gray-50">
      ...
      >
        ...
        <h1 className="relative text-3xl md:text-5xl font-bold mb-2 z-10">
          {language === "EN"
            ? "Lucid Cars Collection"
            : "লুসিড গাড়ির কালেকশন"}
        </h1>
        <p className="relative text-sm md:text-lg z-10">
          {language === "EN"
            ? "Explore our latest Lucid models with detailed specs and pricing."
            : "আমাদের সর্বশেষ লুসিড মডেলগুলো বিস্তারিত স্পেসিফিকেশন এবং মূল্যের সাথে অন্বেষণ করুন।"}
        </p>
      </section>
